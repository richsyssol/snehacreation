...
const Footer = () => {
  ...
  return (
    <motion.footer
      ...
      className="bg-[#f8f8f8] text-[#1f1c32] pt-16 pb-8 px-6 md:px-16 rounded-t-3xl shadow-inner"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        >
          <h2 className="text-2xl font-bold mb-4 text-[#934745]">
            Sneha Creation
          </h2>
          <p className="text-sm text-[#1f1c32] mb-4">
          ...
          <div className="flex gap-4 mt-6">
            {socialIcons.map(({ icon: Icon, label, color }, index) => (
              <motion.a
                ...
                title={label}
                className={`cursor-pointer bg-white p-3 rounded-full shadow-sm hover:bg-[#c5c5c4] ${color}`}
              >
                <Icon size={18} />
              </motion.a>
            ))}
        ...
        >
          <h3 className="text-xl font-semibold mb-4 text-[#934745]">
            Our Products
          </h3>
          <ul className="space-y-2">
            {productCategories.map((link, index) => (
              ...
              >
                <a
                  href={link.link}
                  className="text-[#1f1c32] hover:text-[#834140] transition-colors flex items-center"
                >
          ...
          <ul className="space-y-2">
            {quickLinks.map((link, index) => (
              ...
              >
                <a
                  href={link.link}
                  className="text-[#1f1c32] hover:text-[#834140] transition-colors"
                >
                  {link.name}
                </a>
              </motion.li>
        ...
        >
          ...
          <ul className="text-sm text-[#1f1c32] space-y-3">
            <li className="flex items-start gap-3">
              <IoLocationOutline size={20} className="text-[#934745] mt-1" />
              <span>
            ...
            <li className="flex items-center gap-3">
              <IoCallOutline size={20} className="text-[#934745]" />
              <div>
                <a href="tel:+919876543210" className="hover:text-[#834140]">
                  +91 9876543210
                </a>
            ...
            <li className="flex items-center gap-3">
              <MdOutlineEmail size={20} className="text-[#934745]" />
              <a
                href="mailto:info@snehacreation.com"
                className="hover:text-[#834140]"
              >
                info@snehacreation.com
              </a>
            </li>
            <li className="flex items-center gap-3">
              <BsHandbag size={20} className="text-[#934745]" />
      ...
      <motion.div
        ...
        className="mt-16 text-center text-sm text-[#1f1c32] border-t border-[#c5c5c4] pt-6"
      >
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p>
            © {new Date().getFullYear()}{" "}
            <span className="font-semibold text-[#934745]">Sneha Creation</span>
            . All Rights Reserved.
          </p>
          <div className="flex gap-4 mt-3 md:mt-0">
            <a href="#" className="text-[#1f1c32] hover:text-[#834140]">
              Privacy Policy
            </a>
            <a href="#" className="text-[#1f1c32] hover:text-[#834140]">
              Terms of Service
